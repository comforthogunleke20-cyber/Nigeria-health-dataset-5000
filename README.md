# Nigeria Health Dataset - 5000 patients | BigQuery project
## Introduction
...
Run SQL queries to answer key questions:
-Total Patients
...
Took screenshots of all query results as proof of work (uploaded here)
##Tools Used
-Google BigQuery (SQL)
-Github
##Author
